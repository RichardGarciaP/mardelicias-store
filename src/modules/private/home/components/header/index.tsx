  ...
  return (
    <View style={styles.container}>
      <View style={styles.wrapper}>
        ...
        <View>
          <Typography style={styles.nameUser} translate={false}>{user ? `${user?.user_metadata.first_name} ${user?.user_metadata.last_name}`: 'Invitado'}</Typography>
          <View style={styles.row}>
            <Icon customStyles={styles.iconLocation} icon={location} />
            <Typography style={styles.location} translate={false}>{user ? user?.user_metadata.city : 'Invitado'}</Typography>
          </View>
        </View>
      </View>
    </View>
